        ...
        <div class="left-proof">
          <div class="proof-avatars">
            <img
              v-for="n in 4"
              :key="n"
              :src="`https://i.pravatar.cc/28?img=${n + 14}`"
              class="proof-avatar"
              alt=""
              loading="lazy"
            >
        ...
        <form class="login-form" @submit.prevent="handleSubmit" novalidate>
          ...
          <div class="field-group">
            ...
            <div :class="['field-wrap', { error: errors.password, focused: focusedField === 'password' }]">
              <div class="field-icon">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><rect x="3" y="11" width="18" height="11" rx="2" ry="2" stroke="currentColor" stroke-width="1.8"/><path d="M7 11V7a5 5 0 0 1 10 0v4" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>
              </div>
              <input
                id="password"
              ...
              <button type="button" class="pass-toggle" @click="showPass = !showPass" :aria-label="showPass ? 'Masquer' : 'Afficher'">
                <svg v-if="!showPass" width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" stroke="currentColor" stroke-width="1.8"/><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="1.8"/></svg>
          ...
          <div class="remember-row">
            <label class="check-label">
              ...
              <span class="check-box">
                <svg v-if="form.remember" width="10" height="10" viewBox="0 0 24 24" fill="none"><path d="M20 6L9 17l-5-5" stroke="white" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg>
              </span>
          ...
          >
            ...
            <span v-else class="submit-btn__loader">
              <svg class="spin" width="18" height="18" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="rgba(255,255,255,0.3)" stroke-width="3"/><path d="M12 2a10 10 0 0 1 10 10" stroke="white" stroke-width="3" stroke-linecap="round"/></svg>
              Connexion en cours…
            </span>
          </button>
...
/* Blobs */
.left-blobs { position: absolute; inset: 0; pointer-events: none; z-index: 0; }
.lb { position: absolute; border-radius: 50%; filter: blur(70px); }
.lb--1 { width: 350px; height: 350px; background: rgba(99,102,241,0.3); top: -80px; left: -80px; animation: lbFloat 9s ease-in-out infinite; }
.lb--2 { width: 280px; height: 280px; background: rgba(124,58,237,0.25); bottom: 80px; right: -60px; animation: lbFloat 11s ease-in-out infinite reverse; }
.lb--3 { width: 200px; height: 200px; background: rgba(16,185,129,0.12); top: 50%; left: 50%; animation: lbFloat 7s ease-in-out infinite 2s; }
@keyframes lbFloat { 0%,100%{transform:translate(0,0)} 50%{transform:translate(20px,-20px)} }
...
.proof-text { font-size: 0.78rem; color: rgba(255,255,255,0.6); }
...
.form-logo-mobile { display: none; margin-bottom: 32px; }
...
.form-sub-link:hover { color: #4338CA; text-decoration: underline; }

/* SSO */
.sso-group { display: flex; gap: 10px; margin-bottom: 20px; }
.sso-btn {
  flex: 1;
  display: flex;
  align-items: center;
...
.field-wrap.focused .field-icon { color: #4F46E5; }
...
.pass-toggle:hover { color: #52525B; }
...
.check-text { font-size: 0.83rem; font-weight: 500; color: #52525B; }
...
@media (max-width: 900px) {
  ...
  .form-logo-mobile { display: flex; justify-content: center; }
  .form-container { padding: 0 0 40px; }
}

@media (max-width: 480px) {
  .login-right { padding: 20px 16px; }
  .sso-group { flex-direction: column; }
